...
The recommended way to install FavoriteFiles is via [Package Control][package-control].  Package Control will install
the correct branch on your system and keep it up to date.
...
/// warning | Warning
This is not the recommended way to install FavoriteFiles for the average user.  Installing this way **will not** get
automatically updated.

If you are forking for a pull request, you should **just** clone FavoriteFiles and run Package Control's
`Satisfy Dependency` command to get all the dependencies.
///

For those who want to install FavoriteFiles without package control, here are the steps.  It understood that some people
