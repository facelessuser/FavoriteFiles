...
__version__ = "1.6.1"
__pc_name__ = 'FavoriteFiles'

CSS = '''
div.favorite-files { padding: 10px; margin: 0; }
.favorite-files h1, .favorite-files h2, .favorite-files h3,
.favorite-files h4, .favorite-files h5, .favorite-files h6 {
    {{'.string'|css}}
}
.favorite-files blockquote { {{'.comment'|css}} }
.favorite-files a { text-decoration: none; }
'''
...
class FavoriteFilesSupportInfoCommand(sublime_plugin.ApplicationCommand):
    """Support info."""
...
class FavoriteFilesOpenSiteCommand(sublime_plugin.ApplicationCommand):
    """Open site links."""
...
class FavoriteFilesDocCommand(sublime_plugin.WindowCommand):
    """Open doc page."""
...
class FavoriteFilesChangesCommand(sublime_plugin.WindowCommand):
    """Changelog command."""
